...
**类比：USB 插盘 vs 报个大概位置让它自己找。** 点名文件、IDE 自动带上下文，就像把一块「资料 U 盘」直接插进 Codex 的工作台——插上即用，它要的资料一秒到位；你只甩一句「资料大概在三楼某个柜子，你自己找一下」，它还得满档案室翻，翻错了更耽误事。（[02 核心概念](02-core-concepts.md) 里 MCP 那个 USB 接口比喻是讲「插外部能力」，这里是「插资料」，一个意思的两种用法。）
